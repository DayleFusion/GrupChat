          ...
          child: ListView(
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  Text("Grup Oluşturun Yada Katılın", style: TextStyle(color: Colors.white, fontSize: 40.0, fontWeight: FontWeight.bold)),
                  ...
                  TextFormField(
                    ...
                    validator: (val) => val.length < 6 ? 'Parola uygun depil' : null,
                    obscureText: true,
                    onChanged: (val) {
                      setState(() {
                        password = val;
                  ...
                  SizedBox(
                    ...
                    child: RaisedButton(
                      ...
                      child: Text('Giriş Yap', style: TextStyle(color: Colors.white, fontSize: 16.0)),
                      onPressed: () {
                        _onSignIn();
                      }
                    ),
